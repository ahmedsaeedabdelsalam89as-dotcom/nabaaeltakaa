...
if(pkg.version!=='1.13.25') throw new Error('Expected workspace version 1.13.25');
if(!html.includes('— إصدار 1.13.25 — 2026-09-13')) throw new Error('Visible header version/date drift');
...
for(const marker of [
  ...
  'local_only','deep_research','preferZeroToken:true','externalTokens:0',"var APP_VERSION = '1.13.25'",
