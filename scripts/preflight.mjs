...
if(pkg.version!=='1.52.0') throw new Error('Expected workspace version 1.52.0');
if(!html.includes('— إصدار 1.52.0 — 2026-09-26')) throw new Error('Visible header version/date drift');
...
for(const marker of [
  ...
  'local_only','deep_research','preferZeroToken:true','externalTokens:0',"var APP_VERSION = '1.52.0'",
...
if(sha!=='7916b27935bb1ad9fa8e7fa97a2b5e7f7c0f4a3b83019fb6a668db3f3360c472') throw new Error('data-bundle changed');
