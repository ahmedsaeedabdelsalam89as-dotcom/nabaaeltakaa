...
if(pkg.version!=='1.50.1') throw new Error('Expected workspace version 1.50.1');
if(!html.includes('— إصدار 1.50.1 — 2026-09-26')) throw new Error('Visible header version/date drift');
...
for(const marker of [
  ...
  'local_only','deep_research','preferZeroToken:true','externalTokens:0',"var APP_VERSION = '1.50.1'",
